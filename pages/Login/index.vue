<template>
  <v-layout fill-height align-center justify-center>
   <v-img style="position: absolute; filter: brightness(50%); width: 100%;" src="/bg.jpeg"></v-img>
    <v-card style="position: relative; z-index: 100;" outlined :width="$vuetify.breakpoint.smAndDown ? '80%' : '30%'" class="d-block justify-center align-center rounded-xl pa-8" elevation="8" shaped>
